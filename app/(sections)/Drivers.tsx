      ...
      <header className="mb-8 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400">
            Ranking actualizado con datos estáticos de ejemplo.
          </p>
        </div>
        <span className="text-xs uppercase tracking-widest text-slate-500">Última actualización · julio 2024</span>
      </header>
