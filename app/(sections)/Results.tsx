...
export default async function Results() {
  const [results, drivers, teams] = await Promise.all([getResults(), getDrivers(), getTeams()]);
    ...
    <section id="resultados" aria-labelledby="results-title" className="container mx-auto px-6">
      <header className="mb-8 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400">Última carrera y standings generales actualizados contra Ergast.</p>
        </div>
