...
import { getDrivers, getNextGrandPrix, getSchedule, getTeams } from "@/lib/data";
...
function buildSearchItems(drivers: Driver[], teams: Team[]): QuickSearchItem[] {
  ...
  for (const grandPrix of getSchedule()) {
